...
- Система позволяет управлять отоплением в доме

**Мониторинг температуры:**

- Пользователи могут просматривать текущую температуру в своих домах через веб-интерфейс
- Система получает данные о температуре с датчиков, установленных в их домах.
...
* домен: Мониторинг температуры
  * поддомен: обработка показаний с датчиков
  * поддомен: аналитика данных
